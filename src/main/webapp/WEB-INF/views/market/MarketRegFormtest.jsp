                        ...
                        <div class="tab-content" id="pills-tabContent2">
                            <div class="tab-pane fade show active" id="pills-ome2" role="tabpanel" aria-labelledby="pills-home-tab2">
                                <form action="insertMarketInfo" method="post">
                                    <div class="form-group input-group">
                                        <input type="text" class="form-control" name="marketId" id="marketId" placeholder="아이디">
                                        <div id ="id_check"></div>
                                    ...
                                    <div class="form-group input-group">
                                        <input type="password" class="form-control" name="password2" id="password2" onkeyup="pwdConfirm()" placeholder="비밀번호 확인">
                                    </div>
                                    <div id ="pwd2_check"></div>
                                    <div class="form-group input-group">
                                        <input type="text" class="form-control" name="marketName" id="marketName" placeholder="이름">
                            ...
                            <div class="tab-pane fade" id="pills-profile2" role="tabpanel" aria-labelledby="pills-profile-tab2">
                                <form action="#">
                                    ...
                                    <button type="submit" id=btn_reg class="btn btn-log btn-block btn-thm" onclick="Checkfield()">회원가입 </button>
                                    <hr>
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <button type="submit" class="btn btn-block btn-fb"><i class="fa fa-facebook float-left mt5"></i> Log In via Facebook</button>
...
<script type="text/javascript">
    ...
    function Checkfield() {
        if ($("#marketId").val().trim() === "") {
            alert("아이디를 입력하세요.");
            return false;
        }
        if ($("#marketName").val().trim() === "") {
            alert("이름을 입력하세요.");
            return false;
        }
